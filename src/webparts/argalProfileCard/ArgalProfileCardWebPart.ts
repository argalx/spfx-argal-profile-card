...
export default class ArgalProfileCardWebPart extends BaseClientSideWebPart<IArgalProfileCardWebPartProps> {
  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = "";

  public render(): void {
    const element: React.ReactElement<IArgalProfileCardProps> =
      React.createElement(ArgalProfileCard, {
